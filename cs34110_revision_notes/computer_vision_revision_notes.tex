...
\begin{itemize}
\item
  Simple model: Pinhole Camera (2D-representation of 3D-world)
  ...
  \end{itemize}
\item
  When projecting objects, they appear upside down. Objects that are
  closer appear bigger.
\item
  Difficulty of CV = The distance between the \emph{camera} and the
  \emph{object} is \textbf{non-recoverable} from a \emph{single
  viewpoint}.
\end{itemize}
